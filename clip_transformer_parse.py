...
basePath    = "./"
onnxFile    = "sd_clip_subgraph_layernorm.onnx"
trtFile     = basePath + "sd_clip_subgraph_layernorm.engine"
...
if os.path.isfile(trtFile):
    ...
    if isForSubmit:
        ...
        profile.set_shape(inputT0.name, (1, 16, 80), (16, 256, 80), (16, 256, 80))
        inputT1 = network.get_input(1)
        inputT1.shape = [-1]
        profile.set_shape(inputT1.name, (1,), (16,), (16,))
