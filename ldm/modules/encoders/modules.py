...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device="cuda", max_length=77,
        ...
        # print("engine exists", os.path.exists("./sd_clip_transformer.engine"))
        # with open("./sd_clip_transformer.engine", 'rb') as f:
        #     engine_str = f.read()
    ...
    def forward(self, text):
        ...
        # temp = torch.zeros(1, self.max_length, 768, dtype=torch.float32).to("cuda")
        ...
        # print("compare outputs with pytorch")
