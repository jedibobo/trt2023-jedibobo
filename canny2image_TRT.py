        ...
        for k, v in self.state_dict.items():
            ...
            if k == "clip":
                ...
                if not os.path.isfile("sd_clip_transformer_fp16.engine"):
                    ...
                    os.system("trtexec --onnx=sd_clip_subgraph.onnx --saveEngine=sd_clip_transformer_fp16.engine --fp16 --int8")
            ...
            # 再导出control_net
                ...
                if not os.path.isfile("sd_control_fp16.engine"):
                    ...
                    os.system(
                        "trtexec --onnx=sd_control_sanitize.onnx --saveEngine=sd_control_fp16.engine --fp16 --int8"
                    )
            ...
            # 再导出unet
                ...
                if not os.path.isfile("sd_unet_fp16.engine"):
                    ...
                    # )
                    os.system("trtexec --onnx=unet-onnx/sd_unet.onnx  --saveEngine=sd_unet_fp16.engine --fp16 --int8 --optShapes=x_in:1x4x32x48,t_in:1,c_in:1x77x768,control_in_0:1x320x32x48,control_in_1:1x320x32x48,control_in_2:1x320x32x48,control_in_3:1x320x16x24,control_in_4:1x640x16x24,control_in_5:1x640x16x24,control_in_6:1x640x8x12,control_in_7:1x1280x8x12,control_in_8:1x1280x8x12,control_in_9:1x1280x4x6,control_in_10:1x1280x4x6,control_in_11:1x1280x4x6,control_in_12:1x1280x4x6")
                print("finished converting control model")
            ...
            # 再导出vae
                ...
                if not os.path.isfile("sd_vae_fp16.engine"):
                    ...
                    os.system(
                        "trtexec --onnx=sd_vae_sanitize.onnx --saveEngine=sd_vae_fp16.engine --fp16 --int8"
                    )
